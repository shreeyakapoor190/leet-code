...
public:
    int minDeletions(string s) {
        ...
        for (int i = 24; i >= 0; i--) {
            ...
            if(freq[i] == 0) break; // if frequency is 0 that means no more character is left kyuki sort hokar saara zero pehle aajayega aur last me hoga bas digit wla count
